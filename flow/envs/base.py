    ...
    * compute_reward
    ...
    def render(self, reset=False, buffer_length=5):
        ...
        if self.sim_params.render in ['gray', 'dgray', 'rgb', 'drgb']:
            ...
            # sumo-gui render
            print("here")
            self.k.kernel_api.gui.screenshot("View #0", f"/home/michael/Desktop/flow_screenshots/state_{self.k.id}.jpeg")
        
        time_taken = time.time() - start_time

        # with open(f"./time_taken_SPR{self.k.id}.txt", "a") as logfile:
